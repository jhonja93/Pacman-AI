...
void Fantasma::moveGhost(){
    ...
    if (gdir == 0){
        ...
        if (gpos_x % 16 == 0 && gpos_y % 16 == 0) {
                ...
                do{
                    ...
                    if (gdir == 0) 
                        if (gpos_next_l == 'I'){
                            do{
                                gdir = rand()%4;
                            }while(gdir==1 or gdir == 0);
                        }  
                    else if (gdir == 2)
                        if (gpos_next_u == '-'){
                            do{
                                gdir = rand()%4;
                            }while(gdir==1 or gdir == 2);
                        } 
                    else if (gdir == 3) 
                        if (gpos_next_d == '-'){
                            do{
                                gdir = rand()%4;
                            }while(gdir==1 or gdir == 3);
                        } 
            ...
            if (gpos_x == 0) gpos_x = 27*16;//atajo
            else gdir = rand()%4;
    ...
    if(gdir == 1) {
        if (gpos_x % 16 == 0 && gpos_y % 16 == 0) {
                ...
                do{
                    ...
                    if (gdir == 1) 
                        if (gpos_next_r == 'I'){
                            do{
                                gdir = rand()%4;
                            }while(gdir ==0 or gdir == 1);
                        }  
                    else if (gdir == 2)
                        if (gpos_next_u == '-'){
                            do{
                                gdir = rand()%4;
                            }while(gdir==0 or gdir == 2);
                        } 
                    else if (gdir == 3) 
                        if (gpos_next_d == '-'){
                            do{
                                gdir = rand()%4;
                            }while(gdir==0 or gdir == 3);
                        } 
            ...
            if (gpos_x == 27*16) gpos_x = 0;//atajo
            else gdir = rand()%4;
                ...
                do{
                    ...
                    if (gdir == 0) 
                        if (gpos_next_l == 'I'){
                            do{
                                gdir = rand()%4;
                            }while(gdir == 3 or gdir == 0);
                        }  
                    else if (gdir == 1)
                        if (gpos_next_r == 'I'){
                            do{
                                gdir = rand()%4;
                            }while(gdir== 3 or gdir == 1);
                        } 
                    else if (gdir == 2) 
                        if (gpos_next_u == '-'){
                            do{
                                gdir = rand()%4;
                            }while(gdir== 3 or gdir == 2);
                        } 
                }while(gdir==3);

                if (gdir == 0) gpos_x -=2; 
                else if (gdir == 1) gpos_x +=2;
                else if (gdir == 2) gpos_y -=2;
            }
           else gdir = rand()%4;
                ...
                do{
                    ...
                    if (gdir == 0) 
                        if (gpos_next_l == 'I'){
                            do{
                                gdir = rand()%4;
                            }while(gdir == 2 or gdir == 0);
                        }  
                    else if (gdir == 1)
                        if (gpos_next_r == 'I'){
                            do{
                                gdir = rand()%4;
                            }while(gdir== 2 or gdir == 1);
                        } 
                    else if (gdir == 2) 
                        if (gpos_next_d == '-'){
                            do{
                                gdir = rand()%4;
                            }while(gdir== 2 or gdir == 3);
                        } 
                }while(gdir==2);
