...
void Fantasma::moveGhost(){
    ...
    if (gdir == 0){
        if (gpos_x % 16 == 0 && gpos_y % 16 == 0) {
            ...
            if(gpos_next== 'o' or gpos_next == ' ' or gpos_next == 'O' or gpos_next == '_' or gpos_next == 'F' or gpos_next== 'x') gpos_x -=2;
            else if (gpos_x == 0) gpos_x = 27*16;//atajo
            else gdir = rand()%4; // aleatorio por ahora
    ...
    if(gdir == 1) {
        if (gpos_x % 16 == 0 && gpos_y % 16 == 0) {
            gpos_next = table[gpos_y/16][(gpos_x+16)/16];
            if(gpos_next == 'o' or gpos_next == ' ' or gpos_next == '_' or gpos_next == 'O' or gpos_next == 'F' or gpos_next== 'x') gpos_x +=2;
    ...
    if(gdir == 2) {
        if (gpos_x % 16 == 0 && gpos_y % 16 == 0) {
            ...
            if(gpos_next == 'o' or gpos_next == ' ' or gpos_next == 'O' or gpos_next == '_' or gpos_next == 'F' or gpos_next== 'x') gpos_y -=2;
            else gdir = rand()%4;
        }else{gpos_y -=2;}
    }
    if(gdir == 3) {
